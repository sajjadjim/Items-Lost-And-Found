  ...
  return (
    <div className="min-h-screen bg-gradient-to-r from-blue-100 to-purple-200 flex items-center justify-center p-4">
      <div className="bg-white shadow-2xl rounded-2xl max-w-4xl w-full grid grid-cols-1 md:grid-cols-2 overflow-hidden">
        {/* Left Section */}
        <div className="bg-gradient-to-tr from-blue-500 to-purple-600 text-white p-10 flex flex-col justify-between">
          <div>
        ...
        <div className="p-10">
          <form className="space-y-6">
            ...
            <button
              type="submit"
              className="w-full py-3 bg-purple-600 hover:bg-purple-700 text-white font-bold rounded-lg shadow-md transition duration-300"
            >
              Send Message
            </button>
          </form>
